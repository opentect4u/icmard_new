												...
												<tr id="row_1">
													<td>
														<div class="form-group">
															<select name="item[]" class="form-control select2 required" id="item_1" required>
													...
													<td>
														<div class="form-group">
															<select name="vendor[]" class="form-control select2 required" id="vendor_1" required>
																<option value="">Select</option>
																<?php
			...
			if (x < count) {
				if ($('#item_' + x).val() != '') {
					...
					$('#table').append('<tr id="row_' + x + '">' +
						'<td> <div class="form-group"> <select name="item[]" class="form-control select' + x + ' required" id="item_' + x + '" required> <option value="">Select</option> <?php foreach ($itemdtls as $item) { ?> <option value="<?php echo $item->id; ?>"><?php echo $item->item_name; ?></option> <?php } ?> </select> </div> </td>' +
						'<td> <div class="form-group"> <select name="vendor[]" class="form-control select' + x + ' required" id="vendor_' + x + '" required> <option value="">Select</option> <?php foreach ($tenantdtls as $vendor) { ?> <option value="<?php echo $vendor->uin; ?>"><?php echo $vendor->cust_name; ?></option> <?php } ?> </select> </div> </td>' +
