...
class Master extends CI_Model
{
    ...
    function save_subcatg($data)
    {
        if ($data['id'] > 0) { // FOR UPDATE
            ...
            if ($this->db->update('md_stk_sub_catg', $input)) {
                return true;
            } else {
                return false;
            }
            ...
            if ($this->db->insert('md_stk_sub_catg', $input)) {
                return true;
            } else {
                return false;
            }
    ...
    function save_stakeholder_type($data)
    {
        if ($data['id'] > 0) { // FOR UPDATE
            $input = array(
                'name' => $data['name'],
            ...
            if ($this->db->update('md_stakeholder_type', $input)) {
                return true;
            } else {
                return false;
            }
            ...
            if ($this->db->insert('md_stakeholder_type', $input)) {
                return true;
            } else {
                return false;
            }
